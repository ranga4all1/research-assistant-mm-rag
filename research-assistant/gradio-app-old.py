...
def create_gradio_app():
    ...
    with gr.Blocks() as interface:
        ...
        monitoring_stats = gr.JSON(label="Monitoring Statistics", value=lambda: monitor.get_metrics_summary())
        refresh_button = gr.Button("Refresh Monitoring Stats")

        def refresh_monitoring():
            return monitor.get_metrics_summary()

        refresh_button.click(refresh_monitoring, outputs=[monitoring_stats])
